...
const run = async () => {
  ...
  const img = (id: string) =>
    `https://unsplash.com/photos/${id}/download?auto=format&fit=crop&w=800&q=80`;
  ...
  const sampleProducts = [
    {
      ...
      discountPrice: 59,
      stock: 42,
      images: [img('LVotgZ43LLU'), img('I-fuIPC441I')],
      abv: 40,
      volume: 750,
    ...
    },
    {
      ...
      price: 54,
      stock: 38,
      images: [img('I-fuIPC441I'), img('LVotgZ43LLU')],
      abv: 45,
      volume: 750,
    ...
    },
    {
      ...
      price: 32,
      stock: 80,
      images: [img('N0uCG9nP2bQ'), img('ngmuMP5mXBc')],
      abv: 40,
      volume: 750,
    ...
    },
    {
      ...
      price: 34,
      stock: 64,
      images: [img('ngmuMP5mXBc'), img('N0uCG9nP2bQ')],
      abv: 38,
      volume: 750,
    ...
    },
    {
      ...
      price: 41,
      stock: 60,
      images: [img('v7EI7UfJINM'), img('yFipWk82IhM')],
      abv: 40,
      volume: 750,
    ...
    },
    {
      ...
      price: 38,
      stock: 70,
      images: [img('yFipWk82IhM'), img('v7EI7UfJINM')],
      abv: 37.5,
      volume: 750,
    ...
    },
    {
      ...
      price: 39,
      stock: 52,
      images: [img('WY75ksog5to'), img('XcBLhA7N0wc')],
      abv: 13,
      volume: 750,
    ...
    },
    {
      ...
      price: 16,
      stock: 110,
      images: [img('tEuhYoWlOVw'), img('Q2tgNTnE54U')],
      abv: 6.5,
      volume: 355,
    ...
    },
    {
      ...
      price: 18,
      stock: 88,
      images: [img('OYJpkJHn7Z8'), img('KXdcYQPIhY8')],
      abv: 7.2,
      volume: 355,
