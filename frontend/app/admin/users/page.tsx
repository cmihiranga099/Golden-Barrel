  ...
  return (
    <AdminGuard>
      <div className="mx-auto max-w-6xl px-6 py-12">
        ...
        <p className="mt-4 text-sm text-[#6f6256]">Assign roles and block accounts.</p>
        <div className="mt-6 glass rounded-2xl p-6">
          <div className="space-y-4 text-sm">
            {users.map((user) => (
              <div key={user._id} className="grid gap-3 border-b border-black/10 pb-4 md:grid-cols-[2fr,1fr,1fr]">
                <div>
            ...
            {users.length === 0 && <p className="text-[#6f6256]">No users found.</p>}
          </div>
        </div>
      </div>
    </AdminGuard>
